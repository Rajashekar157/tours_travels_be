...
def get_dashboard_data_service(db: Session):
    ...
    start = time.time()
    summary = db.execute(
        text("SELECT * FROM dashboard_summary")
    ).mappings().first()
    print("summary:", time.time() - start)
    ...
    print("recent_assignments:", time.time() - start)
    ...
    print("insurance_expiry:", time.time() - start)
    ...
    print("license_expiry:", time.time() - start)
    ...
    print("outstanding_suppliers:", time.time() - start)
